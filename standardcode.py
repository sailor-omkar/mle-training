...
# comparing distribution of each income
# category in different type of splits.
...
print("RMSE on training data for Linear Reg. :", lin_rmse)

lin_mae = mean_absolute_error(housing_labels, housing_predictions)
print("Mean absolute error on training data for Linear Reg. :", lin_mae)
...
print("RMSE on training data for Decision tree :", tree_rmse)
...
print("Following is the test score on various random params. for Rand. Forest")
